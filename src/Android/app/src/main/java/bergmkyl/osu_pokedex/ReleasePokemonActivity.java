...
public class ReleasePokemonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTrainer = (TextView) findViewById(R.id.trainer_release_tv);
        mPokemon = (TextView) findViewById(R.id.pokemon_release_tv);

        getTrainers();
        submitBtn = (Button) findViewById(R.id.releasePokemonBtn);
    ...
    private void getTrainerPokemon() {
        HttpUrl reqUrl = HttpUrl.parse("https://cs496-final-160904.appspot.com" + mTrainerSelf + "/pokemon");
